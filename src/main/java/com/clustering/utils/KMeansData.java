...
import com.clustering.KMeans.Centroid;
import com.clustering.KMeans.Point;
...
public class KMeansData {
	...
	//初始化全为零的中心（测试）
	public static final Object[][] CENTROIDS0 = new Object[][] {
			new Object[] {1, 0.00, 0.00},
			new Object[] {2, 0.00, 0.00},
			new Object[] {3, 0.00, 0.00},
			new Object[] {4, 0.00, 0.00}
	};
	public static final Object[][] CENTROIDStest = new Object[][] {
			new Object[] {1, 1.00, 1.00},
			new Object[] {2, -1.00, -1.00},
			new Object[] {3, 1.00, -1.00},
			new Object[] {4, -1.00, 1.00}
	};
	...
	public static DataSet<Centroid> getDefaultCentroidDataSet(ExecutionEnvironment env) {
		...
		return env.fromCollection(centroidList);//将对应的Collection转换成DataSet
	}
